...
### Step 5. MSS WRS-1 reference image
...
### Step 6. Preview and filter out bad MSS images
...
### Step 8. Correlate the MSS to coincident TM images
...
### Step 9. Harmonize MSS images to TM and export the corrected images
...
2. Add the LandTrendr result to the map using the example code below and run the script. 
```js
Map.addLayer(lt, {}, 'LandTrendr Result');
```
